...
export default async function HomePage() {
  ...
  return (
    <AppLayout user={user}>
      <div className="flex flex-col max-h-[calc(100dvh-4rem)] md:h-auto space-y-0 md:space-y-8 overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3 md:grid-rows-1 grid-rows-3 flex-1 md:flex-none pb-3 md:pb-0 min-h-0">
          <HomeCard
            title="Artifacts"
