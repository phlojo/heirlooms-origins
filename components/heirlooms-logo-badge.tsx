export function HeirloomsLogoBadge({ className = "h-10 w-10" }: { className?: string }) {
  return (
    <div className={`flex shrink-0 items-center justify-center bg-gradient-to-br from-primary to-chart-2 text-primary-foreground shadow-sm rounded-sm ${className}`}>
      <svg
        width="24"
        height="26"
        viewBox="0 0 80 90"
